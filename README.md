...
> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the cms-theme-marketplace public boundary. It m
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-cms-theme-marketplace-filament?sort=semver)](https://github.com/liberusoftware/module-cms-theme-marketplace-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-cms-theme-marketplace-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-cms-theme-marketplace-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-cms-theme-marketplace-filament
```
...
<a href="https://github.com/liberusoftware/module-cms-theme-marketplace-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-cms-theme-marketplace-filament" alt="Contributors to liberusoftware/module-cms-theme-marketplace-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-cms-theme-marketplace-filament/graphs/contributors).
